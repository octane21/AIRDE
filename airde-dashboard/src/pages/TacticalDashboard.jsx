              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={a.id} className={`border-b border-[#1e2d4f]/50 hover:bg-[#162040] transition-colors ${i % 2 === 0 ? '' : 'bg-[#0a1628]/30'}`}>
                    ...
                    <td className="py-2 px-3 font-bold text-slate-200">{a.health}</td>
                    <td className="py-2 px-3"><Badge value={a.risk} /></td>
                    ...
                    <td className="py-2 px-3 text-slate-400">{a.dueDate ? String(a.dueDate).slice(0, 10) : '-'}</td>
                    <td className="py-2 px-3"><Badge value={a.status} /></td>
                    <td className="py-2 px-3 text-slate-400">{a.owner}</td>
                    <td className="py-2 px-3 text-slate-500">{a.notes}</td>
                    <td className="py-2 px-3"><Badge value={a.aiFlag === 'Review' ? 'HIGH' : 'LOW'} />{' '}<span className="text-slate-400">{a.aiFlag}</span></td>
